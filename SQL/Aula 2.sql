...
SELECT * FROM myestudo.videos_canais JOIN videos;

SELECT * FROM myestudo.videos_canais JOIN videos ON videos_canais.fk_video = videos.id_video;

SELECT * FROM myestudo.videos_canais AS vc JOIN videos AS v ON vc.fk_video = v.id_video;

SELECT * FROM myestudo.videos_canais AS vc JOIN videos AS v ON vc.fk_video = v.id_video JOIN canais AS c ON vc.fk_canal = c.id_canal;

SELECT v.nome_video, v.autor_video, c.nome_canal FROM myestudo.videos_canais AS vc JOIN videos AS v ON vc.fk_video = v.id_video JOIN canais AS c ON vc.fk_canal = c.id_canal;

SELECT * FROM myestudo.videos_canais AS vc LEFT OUTER JOIN videos AS v ON vc.fk_video = v.id_video LEFT OUTER JOIN canais AS c ON vc.fk_canal = c.id_canal;

SELECT * FROM myestudo.videos_canais AS vc RIGHT OUTER JOIN videos AS v ON vc.fk_video = v.id_video;

SELECT * FROM myestudo.videos_canais AS vc LEFT OUTER JOIN videos AS v ON vc.fk_video = v.id_video;

SELECT * FROM myestudo.videos_canais AS vc RIGHT OUTER JOIN videos AS v ON vc.fk_canal = v.id_video RIGHT OUTER JOIN canais AS c ON vc.fk_canal = c.id_canal;

SELECT v.nome_video, v.id_video FROM myestudo.videos_canais AS vc LEFT OUTER JOIN videos AS v ON vc.fk_video = v.id_video 
UNION 
SELECT c.nome_canal, c.id_canal FROM myestudo.videos_canais AS vc RIGHT OUTER JOIN canais AS c ON vc.fk_canal = c.id_canal;

insert into myestudo.videos_canais (fk_canal, fk_video) value (4,5);
