...
public class BeerService {
    ...
    public BeerDTO decrement(Long id, int quantityToDecrement) throws BeerNotFoundException, BeerZeroStockException {
        ...
        throw new BeerZeroStockException(id, quantityToDecrement);
    }
}
